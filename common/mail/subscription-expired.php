    ...
    <!--[if mso | IE]>
      ...
      >
        <?= $safeStoreName ?> has been downgraded to our free plan
            ...
            <tr>
              <td
                 align="left" style="font-size:0px;padding:10px 25px;padding-top:5px;padding-bottom:6px;word-break:break-word;"
              >

      <div
         style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;text-align:left;color:#000000;"
      >
        Online payments on your store will now have a 5% charge per transaction.
      </div>
      ...
      >
        <tr>
          ...
          >
            <a
               href="<?= $extendPlanUrl ?>" style="background:#2B546A;color:#ffffff;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
            >
